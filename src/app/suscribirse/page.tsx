    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-emerald-50">
      ...
      <main className="max-w-lg mx-auto px-4 py-8 space-y-6">
        ...
        <Card className="border-2 border-emerald-200 shadow-lg">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-slate-600 mb-6">
              Recibí información importante del barrio directamente en tu
              WhatsApp.
            </p>
            <a
              href={whatsappLink}
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-medium text-slate-900">
                    Enviá el mensaje &quot;ALTA&quot;
                  </p>
                  <p className="text-sm text-slate-500">
                    Esto confirma tu suscripción
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Vas a recibir las notificaciones del barrio
                  </p>
                </div>
              </div>
            </div>
        ...
        <p className="text-center text-sm text-slate-500 px-4">
          Podés darte de baja en cualquier momento enviando &quot;BAJA&quot; al
          mismo número.
        </p>
