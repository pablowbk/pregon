      ...
      <div className="w-full">
        ...
        <div className="flex justify-between mt-1">
          ...
          {charCount && maxLength && (
            <p
              className={cn(
                "text-xs text-slate-400 dark:text-slate-500 ml-auto",
                currentLength > maxLength * 0.9 &&
                  "text-amber-500 dark:text-amber-400",
                currentLength >= maxLength && "text-red-500 dark:text-red-400"
              )}
            >
